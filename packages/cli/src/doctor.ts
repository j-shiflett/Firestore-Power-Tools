...
async function execCapture(cmd: string, args: string[]): Promise<{ ok: boolean; stdout: string }> {
...
export async function doctor(args: { projectId?: string; port?: number; uiUrl?: string }) {
